...
static void clear_properties_panel(AppData *app_data) {
    ...
    if (current_properties.container) {
        gtk_widget_destroy(current_properties.container);
        current_properties.container = NULL;
    }
    ...
    // Add default message
    GtkWidget *label = gtk_label_new("Select a widget to edit properties");
